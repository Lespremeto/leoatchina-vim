...
if has('job') || g:python_version || has('nvim') || has('lua')
    ...
    elseif HasDirectory("vim-visual-multi")
        ...
        let g:VM_maps["Visual Find"]             = '<M-f>'
        let g:VM_maps["Visual Cursors"]          = '<M-c>'
        ...
        let g:VM_maps["Find I Word"]             = 'f]'
        let g:VM_maps["Find A Word"]             = 'f['
        let g:VM_maps["Find I Whole Word"]       = ''
        let g:VM_maps["Find A Subword"]          = 'f)'
        let g:VM_maps["Find A Whole Subword"]    = 'f('
